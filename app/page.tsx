...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="relative flex place-items-center before:absolute before:h-[300px] before:w-[450px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-resy before:blur-2xl before:content-[''] after:absolute after:h-[200px] after:w-[360px] after:-translate-x-1/2 after:bg-gradient-resy after:blur-2xl after:content-[''] before:lg:h-[360px]">
        <img
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Learn about Next.js in an interactive course, built by the Scollable.
          </p>
        </a>
